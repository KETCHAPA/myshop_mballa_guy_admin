        ...
        fields: [
            {
                headerTemplate: function() {
                    return $("<button>").attr("type", "button").text("Bloquer") .addClass("btn btn-primary btn-sm btn-delete mb-0 b-r-4")
                        .click( function () {
                            deleteSelectedItems();
                        });
            },
            ...
            { name: "Ville", type:"", width: 100 },
            { name: "Rue", type: "", width: 100 },
            { name: "Status", type: "", width: 100 },
            { name: "Abonne", type: "", width: 100 },
        ]
    });
    var selectedItems = [];
...
function doAjax(email) {
    ...
    $.ajax({
        ...
        url: SERVER_ENDPOINT + '/clients/' + email,
        method: "POST",
