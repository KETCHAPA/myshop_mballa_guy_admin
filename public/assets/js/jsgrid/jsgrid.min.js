 ...
 */
 ! function(a, b, c) {
    ...
    d.prototype = {
        ...
        loadShading: !0,
        invalidMessage: "Donnees incorrectes!",
            ...
            function(a, b, c) {
                ...
                d.prototype = {
                    ...
                    var e = {
                        ...
                        rangeLength: {
                            message: "La valeur du champ a depasse la taille definie",
                            validator: function(a, b, c) {
                                return a.length >= c[0] && a.length <= c[1]
                            }
                        },
                        minLength: {
                            message: "La valeur du champ est trop petite",
                            validator: function(a, b, c) {
                                return a.length >= c
                            }
                        },
                        ...
                        pattern: {
                            message: "La valeur du champ ne respecte pas le model predefini",
                            validator: function(a, b, c) {
                                return "string" == typeof c && (c = new RegExp("^(?:" + c + ")$")), c.test(a)
                            }
                        },
                        range: {
                            message: "La valeur du champ depasse la taille definie par defaut",
                            validator: function(a, b, c) {
                                return a >= c[0] && a <= c[1]
                            }
                        },
                ...
                function(a, b, c) {
                    ...
                    d.prototype = {
                        ...
                        _getSortingFunc: function() {
                            ...
                            throw Error('Mauvais parametre de filtrage pour le champ "' + this.name + '"!')
                        }
                    }, a.Field = d
                }(jsGrid, jQuery),
                function(a, b) {
                ...
                function(a, b) {
                    ...
                    c.prototype = new d({
                        ...
                        searchModeButtonTooltip: "Switcher poure rechercher",
                        insertModeButtonTooltip: "Switcher pour inserer",
                        ...
                        insertButtonTooltip: "Inserer",
                        updateButtonTooltip: "mettre a jour",
                        ...
                        _createFilterSwitchButton: function() {
                            return this._createOnOffSwitchButton("Filtrage", this.searchModeButtonClass, !0)
                        },
                        _createInsertSwitchButton: function() {
                            return this._createOnOffSwitchButton("Insertion", this.insertModeButtonClass, !1)
                        },
                        ...
                        _createModeSwitchButton: function() {
                            var a = !1,
                            c = b.proxy(function() {
                                d.attr("titre", a ? this.searchModeButtonTooltip : this.insertModeButtonTooltip).toggleClass(this.insertModeButtonClass, !a).toggleClass(this.searchModeButtonClass, a)
                            }, this),
                            d = this._createGridButton(this.modeButtonClass, "", function(b) {
                                a = !a, b.option("Insertion", a), b.option("Filtrage", !a), c()
                            });
                            return c(), d
                        },
