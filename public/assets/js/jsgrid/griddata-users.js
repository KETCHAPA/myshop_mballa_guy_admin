...
(function () {
    ...
    JSON.parse($('#data-target-js').text()).forEach(function (item) {
        data.push({
            'Photo': item.photo == null ? item.gender == 0 ? '../assets/images/backend/no_picture/avatar.png' : '../assets/images/backend/no_picture/avatarFemme.jpg' : '../assets/images/clients/' + item.photo,
            'Nom': item.firstname,
            ...
            'Abonne': item.subscriveShop == 0 ? "<i class=\"fa fa-circle font-success f-12\"></i>" : "<i class=\"fa fa-circle font-warning f-12\"></i>"
        })
    })
    var db = {
