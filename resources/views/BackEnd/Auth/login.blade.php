...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Sep 2020 02:23:36 GMT -->
<head>
                ...
                <div class="col-md-5 p-0 card-left">
                    <div class="card bg-primary">
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Bon retour sur la plateforme</h3>
                                    <p>Connecter vous pour commencer l'administration de votre boutique. Gerer vos produits et vos ventes. Interagissez vos clients</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user mr-2"></span>Connexion</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" action={{ route('login') }} method='POST'>
                                        ...
                                        <div class="form-group">
                                            <input required name="login" class="form-control" placeholder="Nom d'utilisateur" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                ...
                                                <label class="custom-control-label" for="customControlAutosizing">Rester connecte</label>
                                                <a href="#" class="btn btn-default forgot-pass">Mot de passe oublie</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-footer">
                                            <span>Ou connecter vous avec</span>
                                            <ul class="social">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Sep 2020 02:23:57 GMT -->
</html>
